...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', type=str, default='/mnt/nvme/cfmix/test/OTB100',help='tracker result root')
    parser.add_argument('--tracker_prefix', type=str,default='', help='tracker prefix')
    ...
    root = join(realpath(dirname(__file__)), '/mnt/nvme/siamf/testing_dataset/OTB100')
    ...
    trackers=['ECO-HC','DCF','Staple','DCF_MIX','Staple_MIX']
